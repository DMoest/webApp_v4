 ...
 * @param props
 */
export const StockItem: React.FC = (props) => {
    ...
    return (
        <View style={[Style.Base.content]}>
            ...
            <View style={Style.Container.flexBox.row}>
                ...
                <Text style={[Style.Typography.dataRight, {flex: 2}]}>{product.id}</Text>
            </View>

            <View style={Style.Container.flexBox.row}>
                <Text style={[Style.Typography.dataLeft, {flex: 1}]}>Artikel nr: </Text>
                <Text style={[Style.Typography.dataRight, {flex: 2}]}>{product.article_number}</Text>
            </View>

            <View style={Style.Container.flexBox.row}>
                <Text style={[Style.Typography.dataLeft, {flex: 1}]}>Plats: </Text>
                <Text style={[Style.Typography.dataRight, {flex: 2}]}>{product.location}</Text>
            </View>

            <View style={Style.Container.flexBox.row}>
                <Text style={[Style.Typography.dataLeft, {flex: 1}]}>Pris: </Text>
                <Text style={[Style.Typography.dataRight, {flex: 2}]}>{product.price} kr</Text>
            </View>

            <View style={Style.Container.flexBox.row}>
                <Text style={[Style.Typography.dataLeft, {flex: 1}]}>Beskrivning: </Text>
                <Text style={[Style.Typography.dataRight, {flex: 2}]}>{product.description}</Text>
            </View>

            <View style={Style.Container.flexBox.row}>
                <Text style={[Style.Typography.dataLeft, {flex: 1}]}>Specifikation: </Text>
                <Text style={[Style.Typography.dataRight, {flex: 2}]}>{product.specifiers}</Text>
            </View>
